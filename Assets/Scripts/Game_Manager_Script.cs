    ...
    public void TriggerTutorial(int stage)
    {
        ...
        switch (stage)
        {
            case 0:
                ...
                break;
            case 1:
                tutorialLines = new string[] { "Evita les hamburgueses, et faran anar m�s lent.(Clica a qualsevol lloc per continuar)" };
                break;
            case 2:
                tutorialLines = new string[] { "En Sergi ha preparat aquestes begudes m�giques et poden ajudar a seguir endavant. Per exemple aquesta t'augmenta la vel�locitat." };
                break;
            case 3:
